...
import AlbumView from 'app/modules/album-view/album-view';
...
const Routes = () => (
  <div className="view-routes">
    <Switch>
	  ...
	  <PrivateRoute path="/album/:id" exact component={AlbumView} hasAnyAuthorities={[AUTHORITIES.ADMIN, AUTHORITIES.USER]}/>
